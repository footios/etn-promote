...
import "../styles/sass/pages/privacy-policy/privacy-policy.css";

const PrivacyPolicy = () => {
  return (
    <div className="wpembed-container" id="privacy-policy">
      <div className="wpembed-content">
        ...
        <p>
          ...
          or “your”) and this Mobile Application developer (“Operator”, “we”,
          ...
          use the Mobile Application and Services. By accessing and using the
        ...
        <p>
          ...
          you create an account, or fill any forms in the Mobile Application.
          When required, this information may include account details (such as
          user name, unique user ID, password, etc).
        </p>
        <p>
        ...
        <p>
          ...
          13 has provided Personal Information to us through the Mobile
          Application and Services, please contact us to request that we delete
          that child’s Personal Information from our Services.
        </p>
        <p>
          ...
          the necessary precautions to ensure that their children are instructed
        ...
        <p>
          In order to make the Mobile Application and Services available to you,
          or to meet a legal obligation, we may need to collect and use certain
          ...
          or services. Any of the information we collect from you may be used
        ...
        <p>
          ...
          world and if one of the following applies: (i) you have given your
          consent for one or more specific purposes; (ii) provision of
        ...
        <p>
          ...
          Services. This privacy policy was created with the help of{" "}
          <a
            target="_blank"
      ...
      <div className="wpembed-madewith">
